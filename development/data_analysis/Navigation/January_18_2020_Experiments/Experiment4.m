%%
% Experiment #4 
% Description: Experiment #4 assumes that the Realsense T265 and Lidar are
%              both working and are fused. This file plots the Local
%              Position (EKF2) response and compares it with respect to the
%              Vicon Motion Capture System. We essentially want to
%              understand how the Realsense and Lidar contributes to the 
%              EKF2. 
% Plots: 
...
% 
%    Figure 4: Compares EKF (Lidar + VIO + Barometer) with Vicon Motion Capture
%    Figure 5: Compares EKF (Lidar + VIO + Barometer) with VIO
%    Figure 6: Compares EKF (Lidar + VIO + Barometer) with Lidar
%
%    Figure 7: Compares EKF (Lidar + VIO + Barometer) with Everything
%%
...
ViconTimeOffset = -4.8 + 7 - 8.65 + 3.8; 
...
xlabel('Time (seconds)');
ylabel('Position Z (meters)');
title('Position Z Comparision Between EKF (Lidar + VIO + Barometer) and Vicon Motion Capture')
...
xlabel('Time (seconds)');
ylabel('Position Z (meters)');
title('Position Z Comparision Between EKF (Lidar + VIO + Barometer) and Intel Realsense T265')
...
% xlabel('Time (seconds)');
% ylabel('Position Z (meters)');
% title('Position Z Comparision Between EKF (Lidar + VIO + Barometer) and Lidar')
...
xlabel('Time (seconds)');
ylabel('Position Z (meters)');
title('Position Z Comparision Between EKF (Lidar + VIO + Barometer) and Realsense/Vicon')
