%%
% Experiment #1 
% Description: Experiment #1 assumes that the Realsense T265 and Lidar are
%              NOT working. This file plots the Local Position (EKF2)
%              response and compares it with respect to the Vicon Motion
%              Capture System. We essentially want to understand what the                   
%              EKF navigation response is when the only input is the 
%              barometer readings and IMU. 
%%
